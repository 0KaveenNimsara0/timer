...
export default function TitleBar() {
  return (
    <div className="titlebar">
      <div style={{ display: 'flex', alignItems: 'center', color: '#666', fontSize: '11px' }}>Timer App</div>
      <div style={{ display: 'flex', height: '100%', WebkitAppRegion: 'no-drag', paddingRight: '12px' } as any}>
        ...
        <button 
          ...
          style={{ height: '100%', background: 'transparent', border: 'none', color: '#94a3b8', cursor: 'pointer', padding: '0 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px' }}
          onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(255,255,255,0.1)'}
          onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
        >
          □
